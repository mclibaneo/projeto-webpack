...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_meu_css_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__css_meu_css_css__);
 ...
 //procura direto direto dentro da pasta modules
 //npm le o css como um module
 //'../' indica para ler na pasta do diretorio raiz
...
fetch(localHost + 'negociacoes', config).then(() => console.log('Dado enviado com sucesso'));
...
let NegociacaoService = class NegociacaoService {
    ...
    obtemNegociacoesDaSemana() {
        ...
        return this._http.get(localHost + 'negociacoes/semana').then(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
    ...
    obtemNegociacoesDaSemanaAnterior() {
        ...
        return this._http.get(localHost + 'negociacoes/anterior').then(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
    ...
    obtemNegociacoesDaSemanaRetrasada() {
        ...
        return this._http.get(localHost + 'negociacoes/retrasada').then(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
